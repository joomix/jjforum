 ...
 */
class JjforumViewPost extends JView
{
	protected $state;
	protected $item;
	...
	//	if ($item->params->get('theme')) {
			$this->_addPath('template', JPATH_COMPONENT.DS.'templates'.DS.'default'.DS.'post');
			$this->_addPath('template', JPATH_SITE.DS.'templates'.DS.$app->getTemplate().DS.'html'.DS.'com_k2'.DS.'templates'.DS.'default'.DS.'post');
			$this->_addPath('template', JPATH_SITE.DS.'templates'.DS.$app->getTemplate().DS.'html'.DS.'com_k2'.DS.'default'.DS.'post');
	//	}
