...
var DEFAULT_SETTINGS = {
    ...
    noResultsText: "<span class='JJred'>No results, click enter to add</span>",
...
$.TokenList = function (input, url_or_data_or_function, settings) {
    ...
    function hide_dropdown () {
		...
		$(input_token).removeClass("loading");
    }
    ...
    function show_dropdown() {
        dropdown
            .css({
                /*position: "absolute",*/
                top: /*$(token_list).offset().top*/309 + $(token_list).outerHeight(),
    ...
    function populate_dropdown (query, results) {
        ...
        if(results && results.length) {
            ...
            $.each(results, function(index, value) {
                ...
                $.data(this_li.get(0), "tokeninput", {"id": value.name, "name": value.name});
            });
